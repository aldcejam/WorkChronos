...
public class WorkEntrieTest {
    ...
    public void givenValidParams_whenCreateWorkEntrie_thenInstantiateWorkEntrie() {
        ...
        final var actualWorkEntrie = WorkEntrie.create(expectedWorkStart, expectedWorkEnd, expectedBreaks);
    ...
    public void givenStartWork_whenWorkStarts_thenWorkStartIsSet() {
        ...
        Assertions.assertNull(actualWorkEntrie.getBreaks());
    }
    ...
    public void givenWorkAlreadyEnded_whenEndWork_thenThrowException() {
        final var workEntrie = WorkEntrie.create(
                LocalTime.of(9, 0),
                LocalTime.of(17, 0),
                new ArrayList<>()
        );
    ...
    public void givenBreakInProgress_whenStartNewBreak_thenThrowException() {
        ...
        final var workEntrie = WorkEntrie.create(LocalTime.of(9, 0), null, breaks);
    ...
    public void givenNoBreaks_whenEndBreak_thenThrowException() {
        final var workEntrie = WorkEntrie.create(LocalTime.of(9, 0), null, new ArrayList<>());
    ...
    public void givenValidJson_whenFromJson_thenReturnWorkEntrie() {
        ...
        final var actualWorkEntrie = WorkEntrie.fromJson(json);
